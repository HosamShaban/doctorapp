                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.all(10),
                        child: const Text(
                          'كن صبورا ومتعاطفا مع المرضى وقدم الراحة والدعم النفسي لهم',
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.all(10),
                        child: const Text(
                          'تطبيقنا وجد لمساعدة المريض على مواظبة قياس السكر باستمرار لذا احرص على ضرورة تذكير المريض بقياس السكر مع كل جلسة تشخيص أو مراجعة',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 15, fontWeight: FontWeight.w700),
                        ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.all(10),
                        child: const Text(
                          'ختاما احرص على وضع مصلحة المرضى في المقام الأول',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 15, fontWeight: FontWeight.w700),
                        ),
