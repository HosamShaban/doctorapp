...
class CancelledAppoitments extends StatefulWidget {
  const CancelledAppoitments({super.key});

  @override
  State<CancelledAppoitments> createState() => _CancelledAppoitmentsState();
}

class _CancelledAppoitmentsState extends State<CancelledAppoitments> {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData is List) {
          for (var doctorData in jsonData) {
            var appointmentStatus = doctorData['status'];
          ...
          var appointmentStatus = jsonData['status'];
          if (appointmentStatus == 'cancelled') {
            setState(() {
